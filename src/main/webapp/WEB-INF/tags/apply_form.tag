...
<form action="process_leave_application" class="col-md-8 col-md-offset-2" id="leaveapplicationform" method="get">		
	...
	<div class="form-group col-md-12">
		...
		<div class="col-md-3">
			<input type="checkbox" name="startWholeDay" checked data-toggle="toggle" checked data-on="Whole Day" data-off="Half Day" data-onstyle="primary" data-offstyle="default" data-width="100%">
		</div>
	</div>
	...
	<div class="form-group col-md-12">
		...
		<div class="col-md-3">
			<input type="checkbox" name="endWholeDay" checked data-toggle="toggle" checked data-on="Whole Day" data-off="Half Day" data-onstyle="primary" data-offstyle="default" data-width="100%">
		</div>
	</div>
